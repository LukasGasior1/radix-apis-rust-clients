...
pub fn resource_holders_page(configuration: &configuration::Configuration, resource_holders_request: models::ResourceHoldersRequest) -> Result<models::ResourceHoldersResponse, Error<ResourceHoldersPageError>> {
