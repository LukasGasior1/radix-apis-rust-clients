...
pub struct StatePackageBlueprintPageResponse {
    ...
    #[serde(rename = "items")]
    pub items: Vec<models::PackageBlueprintCollectionItem>,
...
impl StatePackageBlueprintPageResponse {
    pub fn new(ledger_state: models::LedgerState, items: Vec<models::PackageBlueprintCollectionItem>, package_address: String) -> StatePackageBlueprintPageResponse {
