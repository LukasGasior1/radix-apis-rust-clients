...
pub struct StateEntitySchemaPageResponse {
    ...
    #[serde(rename = "items")]
    pub items: Vec<models::EntitySchemaCollectionItem>,
...
impl StateEntitySchemaPageResponse {
    pub fn new(ledger_state: models::LedgerState, items: Vec<models::EntitySchemaCollectionItem>, address: String) -> StateEntitySchemaPageResponse {
