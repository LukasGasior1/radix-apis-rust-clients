...
pub struct TransactionBalanceChanges {
    ...
    pub fungible_balance_changes: Vec<models::TransactionFungibleBalanceChanges>,
    /// A list of all fee-related fungible balance changes per entity and resource. 
    #[serde(rename = "fungible_fee_balance_changes")]
    pub fungible_fee_balance_changes: Vec<models::TransactionFungibleFeeBalanceChanges>,
    /// A list of all non-fungible changes per entity and resource. 
    #[serde(rename = "non_fungible_balance_changes")]
    pub non_fungible_balance_changes: Vec<models::TransactionNonFungibleBalanceChanges>,
}

impl TransactionBalanceChanges {
    pub fn new(fungible_balance_changes: Vec<models::TransactionFungibleBalanceChanges>, fungible_fee_balance_changes: Vec<models::TransactionFungibleFeeBalanceChanges>, non_fungible_balance_changes: Vec<models::TransactionNonFungibleBalanceChanges>) -> TransactionBalanceChanges {
