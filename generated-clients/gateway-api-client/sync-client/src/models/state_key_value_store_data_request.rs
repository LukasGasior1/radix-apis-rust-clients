...
pub struct StateKeyValueStoreDataRequest {
    ...
    #[serde(rename = "keys")]
    pub keys: Vec<models::StateKeyValueStoreDataRequestKeyItem>,
}

impl StateKeyValueStoreDataRequest {
    pub fn new(key_value_store_address: String, keys: Vec<models::StateKeyValueStoreDataRequestKeyItem>) -> StateKeyValueStoreDataRequest {
