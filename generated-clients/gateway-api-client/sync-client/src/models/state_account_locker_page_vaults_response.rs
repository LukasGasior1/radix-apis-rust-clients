...
pub struct StateAccountLockerPageVaultsResponse {
    ...
    #[serde(rename = "items")]
    pub items: Vec<models::AccountLockerVaultCollectionItem>,
    /// Bech32m-encoded human readable version of the address.
    #[serde(rename = "account_address")]
    pub account_address: String,
    /// Bech32m-encoded human readable version of the address.
    #[serde(rename = "locker_address")]
    pub locker_address: String,
}

impl StateAccountLockerPageVaultsResponse {
    pub fn new(ledger_state: models::LedgerState, items: Vec<models::AccountLockerVaultCollectionItem>, account_address: String, locker_address: String) -> StateAccountLockerPageVaultsResponse {
