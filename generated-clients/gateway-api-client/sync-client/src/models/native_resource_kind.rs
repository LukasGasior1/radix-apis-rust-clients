...
impl std::fmt::Display for NativeResourceKind {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        match self {
            ...
            Self::Secp256k1SignatureResource => write!(f, "Secp256k1SignatureResource"),
            Self::Ed25519SignatureResource => write!(f, "Ed25519SignatureResource"),
            Self::GlobalCallerResource => write!(f, "GlobalCallerResource"),
            Self::PackageOfDirectCallerResource => write!(f, "PackageOfDirectCallerResource"),
            ...
            Self::AccessControllerRecoveryBadge => write!(f, "AccessControllerRecoveryBadge"),
        }
    }
}

impl Default for NativeResourceKind {
    fn default() -> NativeResourceKind {
        Self::Xrd
    }
}
