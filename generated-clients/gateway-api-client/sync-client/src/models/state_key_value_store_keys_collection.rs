...
/// StateKeyValueStoreKeysCollection : Key value store items collection.
...
pub struct StateKeyValueStoreKeysCollection {
    ...
    #[serde(rename = "items")]
    pub items: Vec<models::StateKeyValueStoreKeysResponseItem>,
}

impl StateKeyValueStoreKeysCollection {
    /// Key value store items collection.
    pub fn new(items: Vec<models::StateKeyValueStoreKeysResponseItem>) -> StateKeyValueStoreKeysCollection {
