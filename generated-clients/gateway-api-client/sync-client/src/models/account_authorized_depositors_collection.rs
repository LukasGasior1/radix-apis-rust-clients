...
/// AccountAuthorizedDepositorsCollection : Account resource preferences collection
...
pub struct AccountAuthorizedDepositorsCollection {
    ...
    #[serde(rename = "items")]
    pub items: Vec<models::AccountAuthorizedDepositorsResponseItem>,
}

impl AccountAuthorizedDepositorsCollection {
    /// Account resource preferences collection
    pub fn new(items: Vec<models::AccountAuthorizedDepositorsResponseItem>) -> AccountAuthorizedDepositorsCollection {
