...
/// AccountResourcePreferencesCollection : Account resource preferences collection
...
pub struct AccountResourcePreferencesCollection {
    ...
    #[serde(rename = "items")]
    pub items: Vec<models::AccountResourcePreferencesResponseItem>,
}

impl AccountResourcePreferencesCollection {
    /// Account resource preferences collection
    pub fn new(items: Vec<models::AccountResourcePreferencesResponseItem>) -> AccountResourcePreferencesCollection {
