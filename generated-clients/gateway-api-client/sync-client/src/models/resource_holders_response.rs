...
pub struct ResourceHoldersResponse {
    ...
    #[serde(rename = "items")]
    pub items: Vec<models::ResourceHoldersCollectionItem>,
}

impl ResourceHoldersResponse {
    pub fn new(items: Vec<models::ResourceHoldersCollectionItem>) -> ResourceHoldersResponse {
