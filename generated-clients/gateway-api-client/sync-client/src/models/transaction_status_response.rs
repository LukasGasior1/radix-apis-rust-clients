...
pub struct TransactionStatusResponse {
    ...
    pub known_payloads: Vec<models::TransactionStatusResponseKnownPayloadItem>,
    ...
    #[serde(rename = "permanently_rejects_at_epoch", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub permanently_rejects_at_epoch: Option<Option<u64>>,
    #[serde(rename = "status")]
...
impl TransactionStatusResponse {
    pub fn new(ledger_state: models::LedgerState, intent_status: models::TransactionIntentStatus, intent_status_description: String, known_payloads: Vec<models::TransactionStatusResponseKnownPayloadItem>, status: models::TransactionStatus) -> TransactionStatusResponse {
        TransactionStatusResponse {
            ...
            known_payloads,
            permanently_rejects_at_epoch: None,
            status,
        }
    }
}
