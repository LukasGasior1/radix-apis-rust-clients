...
impl ProgrammaticScryptoSborValueBytes {
    pub fn new(kind: models::ProgrammaticScryptoSborValueKind, element_kind: models::ProgrammaticScryptoSborValueKind, hex: String) -> ProgrammaticScryptoSborValueBytes {
