...
impl ValidatorCollectionItem {
    pub fn new(address: String, effective_fee_factor: models::ValidatorCollectionItemEffectiveFeeFactor, locked_owner_stake_unit_vault: models::ValidatorVaultItem, metadata: models::EntityMetadataCollection, pending_owner_stake_unit_unlock_vault: models::ValidatorVaultItem, pending_xrd_withdraw_vault: models::ValidatorVaultItem, stake_vault: models::ValidatorVaultItem, state: Option<serde_json::Value>) -> ValidatorCollectionItem {
