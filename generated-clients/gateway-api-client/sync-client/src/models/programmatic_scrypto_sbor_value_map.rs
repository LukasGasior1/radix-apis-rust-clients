...
pub struct ProgrammaticScryptoSborValueMap {
    ...
    pub entries: Vec<models::ProgrammaticScryptoSborValueMapEntry>,
    #[serde(rename = "key_kind")]
    pub key_kind: models::ProgrammaticScryptoSborValueKind,
    #[serde(rename = "key_type_name", skip_serializing_if = "Option::is_none")]
    pub key_type_name: Option<String>,
    #[serde(rename = "value_kind")]
    pub value_kind: models::ProgrammaticScryptoSborValueKind,
...
impl ProgrammaticScryptoSborValueMap {
    pub fn new(kind: models::ProgrammaticScryptoSborValueKind, entries: Vec<models::ProgrammaticScryptoSborValueMapEntry>, key_kind: models::ProgrammaticScryptoSborValueKind, value_kind: models::ProgrammaticScryptoSborValueKind) -> ProgrammaticScryptoSborValueMap {
