...
pub struct StateAccountLockersTouchedAtResponseItem {
    ...
    #[serde(rename = "last_touched_at_state_version")]
    pub last_touched_at_state_version: u64,
}

impl StateAccountLockersTouchedAtResponseItem {
    pub fn new(account_address: String, locker_address: String, last_touched_at_state_version: u64) -> StateAccountLockersTouchedAtResponseItem {
