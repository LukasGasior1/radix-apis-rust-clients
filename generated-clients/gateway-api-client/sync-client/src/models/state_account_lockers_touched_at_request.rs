...
pub struct StateAccountLockersTouchedAtRequest {
    ...
    #[serde(rename = "account_lockers")]
    pub account_lockers: Vec<models::AccountLockerAddress>,
}

impl StateAccountLockersTouchedAtRequest {
    pub fn new(account_lockers: Vec<models::AccountLockerAddress>) -> StateAccountLockersTouchedAtRequest {
