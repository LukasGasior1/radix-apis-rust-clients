...
pub struct StateEntityNonFungibleResourceVaultsPageResponse {
    ...
    #[serde(rename = "items")]
    pub items: Vec<models::NonFungibleResourcesCollectionItemVaultAggregatedVaultItem>,
...
impl StateEntityNonFungibleResourceVaultsPageResponse {
    pub fn new(ledger_state: models::LedgerState, items: Vec<models::NonFungibleResourcesCollectionItemVaultAggregatedVaultItem>, address: String, resource_address: String) -> StateEntityNonFungibleResourceVaultsPageResponse {
