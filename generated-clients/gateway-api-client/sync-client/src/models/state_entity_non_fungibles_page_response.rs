...
pub struct StateEntityNonFungiblesPageResponse {
    ...
    #[serde(rename = "items")]
    pub items: Vec<models::NonFungibleResourcesCollectionItem>,
...
impl StateEntityNonFungiblesPageResponse {
    pub fn new(ledger_state: models::LedgerState, items: Vec<models::NonFungibleResourcesCollectionItem>, address: String) -> StateEntityNonFungiblesPageResponse {
