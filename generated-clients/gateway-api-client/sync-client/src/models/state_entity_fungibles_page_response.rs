...
pub struct StateEntityFungiblesPageResponse {
    ...
    #[serde(rename = "items")]
    pub items: Vec<models::FungibleResourcesCollectionItem>,
...
impl StateEntityFungiblesPageResponse {
    pub fn new(ledger_state: models::LedgerState, items: Vec<models::FungibleResourcesCollectionItem>, address: String) -> StateEntityFungiblesPageResponse {
