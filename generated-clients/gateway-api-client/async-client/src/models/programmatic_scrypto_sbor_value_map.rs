...
impl ProgrammaticScryptoSborValueMap {
    pub fn new(entries: Vec<models::ProgrammaticScryptoSborValueMapEntry>, key_kind: models::ProgrammaticScryptoSborValueKind, value_kind: models::ProgrammaticScryptoSborValueKind) -> ProgrammaticScryptoSborValueMap {
