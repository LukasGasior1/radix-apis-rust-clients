...
pub struct StateNonFungibleLocationResponseItem {
    ...
    /// Bech32m-encoded human readable version of the address.
    #[serde(rename = "owning_vault_global_ancestor_address", skip_serializing_if = "Option::is_none")]
    pub owning_vault_global_ancestor_address: Option<String>,
    /// Bech32m-encoded human readable version of the address.
    #[serde(rename = "owning_vault_parent_ancestor_address", skip_serializing_if = "Option::is_none")]
    pub owning_vault_parent_ancestor_address: Option<String>,
}

impl StateNonFungibleLocationResponseItem {
    pub fn new(is_burned: bool, last_updated_at_state_version: u64, non_fungible_id: String) -> StateNonFungibleLocationResponseItem {
