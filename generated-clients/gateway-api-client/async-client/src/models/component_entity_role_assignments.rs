...
pub struct ComponentEntityRoleAssignments {
    ...
    pub entries: Vec<models::ComponentEntityRoleAssignmentEntry>,
...
impl ComponentEntityRoleAssignments {
    pub fn new(entries: Vec<models::ComponentEntityRoleAssignmentEntry>, owner: serde_json::Value) -> ComponentEntityRoleAssignments {
