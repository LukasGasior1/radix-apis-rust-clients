...
impl TransactionPreviewResponse {
    pub fn new(encoded_receipt: String, logs: Vec<models::TransactionPreviewResponseLogsInner>, receipt: serde_json::Value, resource_changes: Vec<serde_json::Value>) -> TransactionPreviewResponse {
