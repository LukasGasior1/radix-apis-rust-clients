...
pub struct StatePackageCodePageResponse {
    ...
    #[serde(rename = "items")]
    pub items: Vec<models::PackageCodeCollectionItem>,
...
impl StatePackageCodePageResponse {
    pub fn new(ledger_state: models::LedgerState, items: Vec<models::PackageCodeCollectionItem>, package_address: String) -> StatePackageCodePageResponse {
