...
pub struct StateEntityMetadataPageResponse {
    ...
    #[serde(rename = "items")]
    pub items: Vec<models::EntityMetadataItem>,
...
impl StateEntityMetadataPageResponse {
    pub fn new(ledger_state: models::LedgerState, items: Vec<models::EntityMetadataItem>, address: String) -> StateEntityMetadataPageResponse {
