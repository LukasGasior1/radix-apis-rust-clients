...
/// AccountLockerVaultCollection : Account Locker Account Resources Collection
...
impl AccountLockerVaultCollection {
    ...
    pub fn new(items: Vec<models::AccountLockerVaultCollectionItem>) -> AccountLockerVaultCollection {
