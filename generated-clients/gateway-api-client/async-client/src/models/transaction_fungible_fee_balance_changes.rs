...
pub struct TransactionFungibleFeeBalanceChanges {
    ...
    #[serde(rename = "type")]
    pub r#type: models::TransactionFungibleFeeBalanceChangeType,
}

impl TransactionFungibleFeeBalanceChanges {
    pub fn new(balance_change: String, entity_address: String, resource_address: String, r#type: models::TransactionFungibleFeeBalanceChangeType) -> TransactionFungibleFeeBalanceChanges {
