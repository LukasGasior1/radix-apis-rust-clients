...
impl NonFungibleResourcesCollectionItemVaultAggregated {
    pub fn new(aggregation_level: models::ResourceAggregationLevel, resource_address: String, vaults: models::NonFungibleResourcesCollectionItemVaultAggregatedVault) -> NonFungibleResourcesCollectionItemVaultAggregated {
