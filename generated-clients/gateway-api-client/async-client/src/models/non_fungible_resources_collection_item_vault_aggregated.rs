...
impl NonFungibleResourcesCollectionItemVaultAggregated {
    pub fn new(resource_address: String, vaults: models::NonFungibleResourcesCollectionItemVaultAggregatedVault) -> NonFungibleResourcesCollectionItemVaultAggregated {
