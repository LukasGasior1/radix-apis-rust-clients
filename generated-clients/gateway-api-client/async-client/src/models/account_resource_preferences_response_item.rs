...
pub struct AccountResourcePreferencesResponseItem {
    ...
    pub resource_preference_rule: models::AccountResourcePreferenceRule,
}

impl AccountResourcePreferencesResponseItem {
    pub fn new(last_updated_at_state_version: u64, resource_address: String, resource_preference_rule: models::AccountResourcePreferenceRule) -> AccountResourcePreferencesResponseItem {
