...
impl StateKeyValueStoreKeysResponse {
    pub fn new(ledger_state: models::LedgerState, items: Vec<models::StateKeyValueStoreKeysResponseItem>, key_value_store_address: String) -> StateKeyValueStoreKeysResponse {
