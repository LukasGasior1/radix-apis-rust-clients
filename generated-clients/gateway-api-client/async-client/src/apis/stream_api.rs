...
pub async fn stream_transactions(configuration: &configuration::Configuration, stream_transactions_request: models::StreamTransactionsRequest) -> Result<models::StreamTransactionsResponse, Error<StreamTransactionsError>> {
