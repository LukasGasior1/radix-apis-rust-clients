# Rust API client for core-api-client-sync
...
Put the package under your project folder in a directory named `core-api-client-sync` and add the following to `Cargo.toml` under `[dependencies]`:
