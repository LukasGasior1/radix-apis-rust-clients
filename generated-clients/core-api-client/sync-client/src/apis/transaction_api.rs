...
/// struct for typed errors of method [`transaction_preview_v2_post`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum TransactionPreviewV2PostError {
    Status400(models::TransactionPreviewV2ErrorResponse),
    Status500(models::TransactionPreviewV2ErrorResponse),
    UnknownValue(serde_json::Value),
}
...
pub fn transaction_call_preview_post(configuration: &configuration::Configuration, transaction_call_preview_request: models::TransactionCallPreviewRequest) -> Result<models::TransactionCallPreviewResponse, Error<TransactionCallPreviewPostError>> {
...
pub fn transaction_parse_post(configuration: &configuration::Configuration, transaction_parse_request: models::TransactionParseRequest) -> Result<models::TransactionParseResponse, Error<TransactionParsePostError>> {
    let local_var_configuration = configuration;
...
pub fn transaction_preview_post(configuration: &configuration::Configuration, transaction_preview_request: models::TransactionPreviewRequest) -> Result<models::TransactionPreviewResponse, Error<TransactionPreviewPostError>> {
    let local_var_configuration = configuration;
...
pub fn transaction_preview_v2_post(configuration: &configuration::Configuration, transaction_preview_v2_request: models::TransactionPreviewV2Request) -> Result<models::TransactionPreviewV2Response, Error<TransactionPreviewV2PostError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/transaction/preview-v2", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());

    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder = local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    }
    local_var_req_builder = local_var_req_builder.json(&transaction_preview_v2_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TransactionPreviewV2PostError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub fn transaction_receipt_post(configuration: &configuration::Configuration, transaction_receipt_request: models::TransactionReceiptRequest) -> Result<models::TransactionReceiptResponse, Error<TransactionReceiptPostError>> {
    let local_var_configuration = configuration;
...
pub fn transaction_status_post(configuration: &configuration::Configuration, transaction_status_request: models::TransactionStatusRequest) -> Result<models::TransactionStatusResponse, Error<TransactionStatusPostError>> {
    let local_var_configuration = configuration;
...
pub fn transaction_submit_post(configuration: &configuration::Configuration, transaction_submit_request: models::TransactionSubmitRequest) -> Result<models::TransactionSubmitResponse, Error<TransactionSubmitPostError>> {
    let local_var_configuration = configuration;
