...
pub fn lts_state_account_all_fungible_resource_balances_post(configuration: &configuration::Configuration, lts_state_account_all_fungible_resource_balances_request: models::LtsStateAccountAllFungibleResourceBalancesRequest) -> Result<models::LtsStateAccountAllFungibleResourceBalancesResponse, Error<LtsStateAccountAllFungibleResourceBalancesPostError>> {
...
pub fn lts_state_account_deposit_behaviour_post(configuration: &configuration::Configuration, lts_state_account_deposit_behaviour_request: models::LtsStateAccountDepositBehaviourRequest) -> Result<models::LtsStateAccountDepositBehaviourResponse, Error<LtsStateAccountDepositBehaviourPostError>> {
    let local_var_configuration = configuration;
...
pub fn lts_state_account_fungible_resource_balance_post(configuration: &configuration::Configuration, lts_state_account_fungible_resource_balance_request: models::LtsStateAccountFungibleResourceBalanceRequest) -> Result<models::LtsStateAccountFungibleResourceBalanceResponse, Error<LtsStateAccountFungibleResourceBalancePostError>> {
    let local_var_configuration = configuration;
...
pub fn lts_stream_account_transaction_outcomes_post(configuration: &configuration::Configuration, lts_stream_account_transaction_outcomes_request: models::LtsStreamAccountTransactionOutcomesRequest) -> Result<models::LtsStreamAccountTransactionOutcomesResponse, Error<LtsStreamAccountTransactionOutcomesPostError>> {
    let local_var_configuration = configuration;
...
pub fn lts_stream_transaction_outcomes_post(configuration: &configuration::Configuration, lts_stream_transaction_outcomes_request: models::LtsStreamTransactionOutcomesRequest) -> Result<models::LtsStreamTransactionOutcomesResponse, Error<LtsStreamTransactionOutcomesPostError>> {
    let local_var_configuration = configuration;
...
pub fn lts_transaction_construction_post(configuration: &configuration::Configuration, lts_transaction_construction_request: models::LtsTransactionConstructionRequest) -> Result<models::LtsTransactionConstructionResponse, Error<LtsTransactionConstructionPostError>> {
    let local_var_configuration = configuration;
...
pub fn lts_transaction_status_post(configuration: &configuration::Configuration, lts_transaction_status_request: models::LtsTransactionStatusRequest) -> Result<models::LtsTransactionStatusResponse, Error<LtsTransactionStatusPostError>> {
    let local_var_configuration = configuration;
...
pub fn lts_transaction_submit_post(configuration: &configuration::Configuration, lts_transaction_submit_request: models::LtsTransactionSubmitRequest) -> Result<models::LtsTransactionSubmitResponse, Error<LtsTransactionSubmitPostError>> {
    let local_var_configuration = configuration;
