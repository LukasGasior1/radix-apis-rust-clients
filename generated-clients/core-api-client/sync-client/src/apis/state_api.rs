...
pub fn state_access_controller_post(configuration: &configuration::Configuration, state_access_controller_request: models::StateAccessControllerRequest) -> Result<models::StateAccessControllerResponse, Error<StateAccessControllerPostError>> {
...
pub fn state_account_post(configuration: &configuration::Configuration, state_account_request: models::StateAccountRequest) -> Result<models::StateAccountResponse, Error<StateAccountPostError>> {
    let local_var_configuration = configuration;
...
pub fn state_component_post(configuration: &configuration::Configuration, state_component_request: models::StateComponentRequest) -> Result<models::StateComponentResponse, Error<StateComponentPostError>> {
    let local_var_configuration = configuration;
...
pub fn state_consensus_manager_post(configuration: &configuration::Configuration, state_consensus_manager_request: models::StateConsensusManagerRequest) -> Result<models::StateConsensusManagerResponse, Error<StateConsensusManagerPostError>> {
    let local_var_configuration = configuration;
...
pub fn state_non_fungible_post(configuration: &configuration::Configuration, state_non_fungible_request: models::StateNonFungibleRequest) -> Result<models::StateNonFungibleResponse, Error<StateNonFungiblePostError>> {
    let local_var_configuration = configuration;
...
pub fn state_package_post(configuration: &configuration::Configuration, state_package_request: models::StatePackageRequest) -> Result<models::StatePackageResponse, Error<StatePackagePostError>> {
    let local_var_configuration = configuration;
...
pub fn state_resource_post(configuration: &configuration::Configuration, state_resource_request: models::StateResourceRequest) -> Result<models::StateResourceResponse, Error<StateResourcePostError>> {
    let local_var_configuration = configuration;
...
pub fn state_validator_post(configuration: &configuration::Configuration, state_validator_request: models::StateValidatorRequest) -> Result<models::StateValidatorResponse, Error<StateValidatorPostError>> {
    let local_var_configuration = configuration;
