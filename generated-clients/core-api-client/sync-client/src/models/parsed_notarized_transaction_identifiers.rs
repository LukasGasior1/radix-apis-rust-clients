...
impl ParsedNotarizedTransactionIdentifiers {
    pub fn new(intent_hash: String, intent_hash_bech32m: String, ledger_hash: String, ledger_hash_bech32m: String, payload_hash: String, payload_hash_bech32m: String, signed_intent_hash: String, signed_intent_hash_bech32m: String) -> ParsedNotarizedTransactionIdentifiers {
