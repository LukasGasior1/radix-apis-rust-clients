...
impl NonFungibleVaultFieldFrozenStatusSubstate {
    pub fn new(is_locked: bool, substate_type: models::SubstateType, value: models::NonFungibleVaultFieldFrozenStatusValue) -> NonFungibleVaultFieldFrozenStatusSubstate {
