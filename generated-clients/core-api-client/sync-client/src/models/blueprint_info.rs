...
impl BlueprintInfo {
    pub fn new(blueprint_name: String, blueprint_version: String, features: Vec<String>, generic_substitutions: Vec<models::GenericSubstitution>, package_address: String) -> BlueprintInfo {
        BlueprintInfo {
            blueprint_name,
            blueprint_version,
            features,
