...
impl SignedTransactionIntentV2 {
    pub fn new(hash: String, hash_bech32m: String, non_root_subintent_signatures: Vec<models::IntentSignatures>, transaction_intent: models::TransactionIntentV2, transaction_intent_signatures: models::IntentSignatures) -> SignedTransactionIntentV2 {
