...
impl NetworkConfigurationResponse {
    pub fn new(address_types: Vec<models::AddressType>, network: String, network_hrp_suffix: String, network_id: u32, usd_price_in_xrd: String, version: models::NetworkConfigurationResponseVersion, well_known_addresses: models::NetworkConfigurationResponseWellKnownAddresses) -> NetworkConfigurationResponse {
