...
pub struct NotarizedTransactionV2 {
    ...
    pub signed_transaction_intent: models::SignedTransactionIntentV2,
}

impl NotarizedTransactionV2 {
    pub fn new(hash: String, hash_bech32m: String, notary_signature: models::Signature, signed_transaction_intent: models::SignedTransactionIntentV2) -> NotarizedTransactionV2 {
