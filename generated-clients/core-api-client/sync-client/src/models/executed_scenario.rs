...
impl ExecutedScenario {
    pub fn new(addresses: std::collections::HashMap<String, String>, committed_transactions: Vec<models::ExecutedScenarioTransaction>, logical_name: String, sequence_number: u32) -> ExecutedScenario {
        ExecutedScenario {
            addresses,
