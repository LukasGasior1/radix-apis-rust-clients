...
impl NonFungibleResourceManagerFieldTotalSupplySubstate {
    pub fn new(is_locked: bool, substate_type: models::SubstateType, value: models::NonFungibleResourceManagerFieldTotalSupplyValue) -> NonFungibleResourceManagerFieldTotalSupplySubstate {
