...
impl SortedIndexBlueprintCollectionSchema {
    pub fn new(r#type: models::BlueprintCollectionSchemaType, allow_ownership: bool, key_type_ref: models::BlueprintPayloadDef, value_type_ref: models::BlueprintPayloadDef) -> SortedIndexBlueprintCollectionSchema {
