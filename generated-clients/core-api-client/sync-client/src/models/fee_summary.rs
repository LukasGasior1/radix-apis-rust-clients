...
impl FeeSummary {
    pub fn new(execution_cost_units_consumed: u64, finalization_cost_units_consumed: u64, xrd_total_execution_cost: String, xrd_total_finalization_cost: String, xrd_total_royalty_cost: String, xrd_total_storage_cost: String, xrd_total_tipping_cost: String) -> FeeSummary {
        FeeSummary {
