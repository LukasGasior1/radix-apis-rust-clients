...
impl BlueprintInterface {
    pub fn new(events: std::collections::HashMap<String, models::BlueprintPayloadDef>, features: Vec<String>, functions: std::collections::HashMap<String, models::FunctionSchema>, generic_type_parameters: Vec<models::GenericTypeParameter>, is_transient: bool, state: models::IndexedStateSchema, types: std::collections::HashMap<String, models::ScopedTypeId>) -> BlueprintInterface {
        BlueprintInterface {
            events,
            features,
            functions,
