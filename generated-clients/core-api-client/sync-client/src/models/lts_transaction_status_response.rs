...
pub struct LtsTransactionStatusResponse {
    ...
    pub committed_state_version: Option<u64>,
    ...
    pub invalid_from_epoch: Option<u64>,
...
impl LtsTransactionStatusResponse {
    pub fn new(intent_status: models::LtsTransactionIntentStatus, known_payloads: Vec<models::LtsTransactionPayloadDetails>, status_description: String) -> LtsTransactionStatusResponse {
