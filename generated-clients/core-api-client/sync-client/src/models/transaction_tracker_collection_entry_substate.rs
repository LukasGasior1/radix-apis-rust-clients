...
impl TransactionTrackerCollectionEntrySubstate {
    pub fn new(is_locked: bool, substate_type: models::SubstateType, key: models::TransactionIdKey, value: models::TransactionTrackerCollectionEntryValue) -> TransactionTrackerCollectionEntrySubstate {
