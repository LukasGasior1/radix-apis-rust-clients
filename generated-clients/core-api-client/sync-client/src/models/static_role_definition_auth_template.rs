...
impl StaticRoleDefinitionAuthTemplate {
    pub fn new(method_accessibility_map: std::collections::HashMap<String, models::MethodAccessibility>, role_specification: models::RoleSpecification) -> StaticRoleDefinitionAuthTemplate {
