...
pub struct TransactionPreviewV2Request {
    ...
    pub options: Option<models::TransactionPreviewV2ResponseOptions>,
    #[serde(rename = "preview_transaction")]
    pub preview_transaction: models::PreviewTransaction,
}

impl TransactionPreviewV2Request {
    pub fn new(network: String, preview_transaction: models::PreviewTransaction) -> TransactionPreviewV2Request {
