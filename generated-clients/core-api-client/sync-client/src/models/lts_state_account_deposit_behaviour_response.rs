...
impl LtsStateAccountDepositBehaviourResponse {
    pub fn new(default_deposit_rule: models::DefaultDepositRule, ledger_header_summary: models::LedgerHeaderSummary, state_version: u64) -> LtsStateAccountDepositBehaviourResponse {
