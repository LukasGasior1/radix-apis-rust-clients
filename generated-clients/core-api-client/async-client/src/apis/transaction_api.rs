...
pub async fn transaction_preview_v2_post(configuration: &configuration::Configuration, transaction_preview_v2_request: models::TransactionPreviewV2Request) -> Result<models::TransactionPreviewV2Response, Error<TransactionPreviewV2PostError>> {
    let local_var_configuration = configuration;
