...
impl TransactionIntentV2 {
    pub fn new(hash: String, hash_bech32m: String, non_root_subintents: Vec<models::SubintentV2>, root_intent_core: models::IntentCoreV2, transaction_header: models::TransactionHeaderV2) -> TransactionIntentV2 {
        TransactionIntentV2 {
            hash,
            hash_bech32m,
            non_root_subintents,
