...
impl BlueprintDefinition {
    pub fn new(function_exports: std::collections::HashMap<String, models::PackageExport>, hook_exports: Vec<models::HookExport>, interface: models::BlueprintInterface) -> BlueprintDefinition {
        BlueprintDefinition {
            function_exports,
            hook_exports,
            interface,
