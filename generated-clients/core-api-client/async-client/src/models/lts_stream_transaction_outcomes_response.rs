...
impl LtsStreamTransactionOutcomesResponse {
    pub fn new(committed_transaction_outcomes: Vec<models::LtsCommittedTransactionOutcome>, count: u32, from_state_version: u64, max_ledger_state_version: u64) -> LtsStreamTransactionOutcomesResponse {
