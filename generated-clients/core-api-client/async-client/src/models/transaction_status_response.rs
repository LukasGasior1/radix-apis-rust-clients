...
impl TransactionStatusResponse {
    pub fn new(intent_status: models::TransactionIntentStatus, known_payloads: Vec<models::TransactionPayloadDetails>, status_description: String) -> TransactionStatusResponse {
