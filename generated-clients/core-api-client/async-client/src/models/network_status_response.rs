...
pub struct NetworkStatusResponse {
    ...
    pub current_state_identifier: models::CommittedStateIdentifier,
...
impl NetworkStatusResponse {
    pub fn new(current_protocol_version: String, current_state_identifier: models::CommittedStateIdentifier, pre_genesis_state_identifier: models::CommittedStateIdentifier) -> NetworkStatusResponse {
