...
impl LtsStateAccountAllFungibleResourceBalancesResponse {
    pub fn new(account_address: String, fungible_resource_balances: Vec<models::LtsFungibleResourceBalance>, ledger_header_summary: models::LedgerHeaderSummary, state_version: u64) -> LtsStateAccountAllFungibleResourceBalancesResponse {
