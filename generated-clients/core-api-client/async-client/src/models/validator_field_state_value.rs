...
impl ValidatorFieldStateValue {
    pub fn new(accepts_delegated_stake: bool, already_unlocked_owner_stake_unit_amount: String, claim_token_resource_address: String, is_registered: bool, locked_owner_stake_unit_vault: models::EntityReference, pending_owner_stake_unit_unlock_vault: models::EntityReference, pending_owner_stake_unit_withdrawals: Vec<models::PendingOwnerStakeWithdrawal>, pending_xrd_withdraw_vault: models::EntityReference, public_key: models::EcdsaSecp256k1PublicKey, stake_unit_resource_address: String, stake_xrd_vault: models::EntityReference, validator_fee_factor: String) -> ValidatorFieldStateValue {
